...
public class PlaceOrderLoginBeforeCheckoutTests : BaseTest
{
    ...
    [Test]
    [Description("16 - Оформление заказа: логин до чекаута")]
    public async Task PlaceOrder_LoginBeforeCheckout_OrderIsConfirmed()
    {
